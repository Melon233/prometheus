...
{
    /// <summary>表示叙事流程对一台 Cinemachine 演出镜头优先级的独占租约，释放后 CameraSystem 会恢复镜头原优先级。</summary>
    public sealed class CutsceneCameraLease : IDisposable
    {
        private CameraSystem owner;

        /// <summary>由 CameraSystem 创建与管理一份演出镜头租约。</summary>
        internal CutsceneCameraLease(CameraSystem owner)
        {
        ...
        public void Dispose()
        {
            ...
            owner = null;
            currentOwner.ReleaseCutsceneCamera(this);
        }
