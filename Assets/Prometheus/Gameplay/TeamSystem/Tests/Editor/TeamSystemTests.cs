...
namespace Xuan.Prometheus.Team.Tests
{
    ...
    public sealed class TeamSystemTests
    {
        ...
        public void SetUp()
        {
            ...
            gameplayKit.AddSystem<IInputSystem>(inputSystem);
            gameplayKit.AddSystem<IEffectSystem>(effectSystem);
            gameplayKit.AddSystem<ITeamSystem>(teamSystem);
        ...
        public void NumberKeySwitch_InterruptsOutgoingActionAndRedirectsSameFrameGameplayInput()
        {
            ...
            eventKit.AddListener<ActiveTeamMemberChangedEvent>(eventData =>
            {
