...
namespace Xuan.Prometheus
{
    ...
    {
        private readonly IAnimationHost host;
        ...
        internal AnimationPlayback(IAnimationHost host, AnimationSemantic semantic, AnimationOwner owner, AnimationPriority priority, int trackIndex, int version)
        {
            this.host = host;
            Semantic = semantic;
            Owner = owner;
        ...
        public bool IsActive => !finished && host != null && host.IsPlaybackActive(this);
