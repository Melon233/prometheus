...
namespace Xuan.Prometheus
{
    ...
    {
        public void Init(CharacterAnimationLibrary lib, SpineComponent spineComp, VfxComponent vfxComp);
    }
    public abstract class AnimationExecutor : IExecutor
    {
        protected CharacterAnimationLibrary lib;
        protected SpineComponent spineComp;
        protected VfxComponent vfxComp;


        public virtual void Init(CharacterAnimationLibrary lib, SpineComponent spineComp, VfxComponent vfxComp)
        {
            this.lib = lib;
    ...
    // [Serializable]
    // public abstract class VfxEntry
    // {
    //     [SerializeField] public GameObject vfx;
    //     [SerializeField] public YefaVfxSlot vfxSlot;
    // }
    [CreateAssetMenu(menuName = "Spiner/CharacterAnimationLibrary")]
