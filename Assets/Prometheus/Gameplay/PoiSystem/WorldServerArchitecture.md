...
> 关联：客户端编排见 [PoiSystem.md](PoiSystem.md)，权威交互流程见 [WorldPersistenceDesign.md](WorldPersistenceDesign.md)，网络分层约束见 [ServiceSystemDesign.md](../ServiceSystem/ServiceSystemDesign.md)。
