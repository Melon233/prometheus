...
namespace Xuan.Prometheus.Logic
{
    ...
    public sealed class UltimateLogic : PlayerCombatActionLogic
    {
        ...
        private void TryStartUltimate()
        {
            ...
            PlayerCombatHitContext hitContext = new PlayerCombatHitContext(ultimateComponent.ColliderProxy, ResolveTalentId("Ultimate"), 0, EffectTag.Attack | EffectTag.Ultimate, DamageActionType.Ultimate, ultimateComponent.TalentScale);
