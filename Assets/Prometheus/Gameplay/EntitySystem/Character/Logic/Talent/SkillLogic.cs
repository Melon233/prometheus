...
namespace Xuan.Prometheus.Logic
{
    ...
    public sealed class SkillLogic : PlayerCombatActionLogic
    {
        ...
        private void TryStartSkill()
        {
            ...
            PlayerCombatHitContext hitContext = new PlayerCombatHitContext(skillComponent.ColliderProxy, ResolveTalentId("Skill"), 0, EffectTag.Attack | EffectTag.Skill, DamageActionType.Skill, skillComponent.TalentScale);
