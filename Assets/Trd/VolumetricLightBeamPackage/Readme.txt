...
** How to install? **
*********************
Simply open the 'Installer' asset in the "Assets/Trd/VolumetricLightBeamPackage/" folder, and click on the 'Install' button in the inspector.
...
- If you have already a previous version of the VolumetricLightBeam plugin installed in your project:
  ...
  - Delete the old plugin version (delete the folder "Assets/Plugins/VolumetricLightBeam/" or "Assets/Trd/VolumetricLightBeam/" depending on your version)
